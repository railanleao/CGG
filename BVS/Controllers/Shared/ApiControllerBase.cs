...
//namespace BVS.Controllers.Shared
//{
//    // O ideal aqui seria termos um controller base para cada versão e setar o atributo ApiVersion.
//    // Ex: v1ControllerBase, v2ControllerBase, etc
